...
//        given
        val incorrectEmailUserProps = UserProps.of(
            loginId = "yeollow",
            password = "Password123!",
            email = "gongsung123",
            name = "knu",
        ...
        val incorrectPasswordUserProps = UserProps.of(
            loginId = "yeollow",
            password = "password123!",
            email = "gongsung123@gmail.com",
            name = "knu",
...
//        when
        val emailUserPersist = mock<CommandUserPersist>() {
        ...
        val passwordUserPersist = mock<CommandUserPersist>() {
...
//        when
        val deleteUserPersist = mock<CommandUserPersist>() {
